...
(function() {
    ...
    let dati = {
        prodotti: [
            { 
                nome: "confezione da 6", 
                prezzo: "€ 3", 
                desc: "6 uova ",
                icon: "🥚"
            },
            { 
                nome: "confezione da 10", 
                prezzo: "€ 4", 
                desc: "10 uova ",
                icon: "🥚"
            },
            { 
                nome: "confezione da 12", 
                prezzo: "€ 5", 
                desc: "12 uova ",
                icon: "🥚"
            },
        ...
        dati.prodotti.forEach(p => {
            el.innerHTML += `
                <div class="card-prodotto">
                    ...
                    <a href="https://wa.me/393319138180?text=Ciao%2C%20vorrei%20ordinare%20${encodeURIComponent(p.nome)}" 
    ...
    function renderOfferta() {
        ...
        el.innerHTML = `
            <div class="offerta-content">
                ...
                <a href="https://wa.me/393319138180?text=Ciao%2C%20vorrei%20approfittare%20dell'offerta%20speciale%21" 
